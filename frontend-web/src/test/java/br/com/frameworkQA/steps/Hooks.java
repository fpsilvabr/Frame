...
import br.com.frameworkQA.framework.FrameworkWordEvidence;
import br.com.frameworkQA.utils.DriverFactory;
import br.com.frameworkQA.framework.FrameworkDriver;

/**
 * Classe Hooks, responsável por agrupar métodos simples com anotações especiais
...
public class Hooks {
    ...
    public void queUtilizoWordParaEvidenciasComSeguintesInformacoes(
    ...
    public void openFirefoxSameSessionBrowserDesktop(Scenario s) throws Exception {
